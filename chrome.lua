...
local function drawLabel(input, x, y, labelColor)
...
local function drawBottom()
  ...
  local drawDebug
  drawDebug = function()
    drawLabel("pshot:" .. tostring(#player.bullets), gameX + gameWidth + grid * 1.5, y - 12 * 4 - 8)
    drawLabel("eshot:" .. tostring(#stage.bullets), gameX + gameWidth + grid * 1.5, y - 12 * 3 - 8)
    drawLabel("enemy:" .. tostring(#stage.enemies), gameX + gameWidth + grid * 1.5, y - 12 * 2 - 8)
    drawLabel("explo:" .. tostring(#explosions.explosions), gameX + gameWidth + grid * 1.5, y - 12 * 1 - 8)
  end
